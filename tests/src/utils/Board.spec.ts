...
describe('freeInPosition', () => {
  it('should return only available numbers', () => {
    ...
    let result = Board.freeInPosition(0, 0, cells);
    expect(result).toEqual([2, 3, 4, 5, 6, 7, 8, 9]);
    ...
    result = Board.freeInPosition(1, 2, cells);
    expect(result).toEqual([2, 4, 5, 6, 7, 8, 9]);
    ...
    result = Board.freeInPosition(2, 2, cells);
    expect(result).toEqual([2, 5, 6, 8, 9]);

    cells = [
      [C(), C(), C(), C(), C(), C(), C(1), C(2), C(3)],
      [C(9), C(), C(), C(), C(), C(), C(4), C(), C(5)],
      [C(), C(), C(), C(), C(), C(), C(8), C(7), C(6)],
    ];
    result = Board.freeInPosition(1, 8, cells);
    ...
    cells = [
      ...
      [C(), C(), C(), C(), C(7), C(), C(), C(), C()],
      [C(), C(), C(), C(), C(), C(), C(), C(), C(9)],
      [C(9), C(), C(), C(), C(2), C(), C(), C(), C()],
    ];
    result = Board.freeInPosition(8, 5, cells);
    expect(result).toEqual([3, 4, 5, 6, 8]);
  });
});
